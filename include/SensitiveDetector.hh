...
#include "G4StateManager.hh"    // For state management
#include "G4Threading.hh"       // For mutex in MT mode
#include "G4AutoLock.hh"        // For thread safety
...
namespace TC {
	...
	private:
                 ...
                 G4int fPhotonCount;  // Instance-specific counter
